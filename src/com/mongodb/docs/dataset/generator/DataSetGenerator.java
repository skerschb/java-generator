...
public class DataSetGenerator {
	...
	public static void main(String args[]) {
  		...
  		final MongoClientURI uri = new MongoClientURI("mongodb://testuser:password@localhost:27017/test?authSource=admin");
		...
		MongoCollection<Product> collection = mongoDB.getCollection("inventory", Product.class);
